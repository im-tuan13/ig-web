        ...
        @foreach ($reels as $index => $reel)
            @php
                $mediaUrl = $reel->images->isNotEmpty()
                    ? '/storage/'.$reel->images->first()->path
                    : $reel->image_url;
            ...
            <section
                ...
                <div class="relative flex h-full max-h-[90vh] w-full max-w-[506px] items-center justify-center overflow-hidden">
                    ...
                    @if ($isVideo)
                        ...
                        >
                                ...
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <div
                                        ...
                                        <template x-if="mediaErrorCode !== null">
                                            <span>
                                                <span>Error: </span>
                                                <span x-text="mediaErrorCode"></span>
                                                <span> — </span>
                                                <span x-text="mediaErrorMessage || 'Unknown media error'"></span>
                                            </span>
                                        </template>
                            ...
                            {{-- Mute button HARUS di luar <a> --}}
                            <button
                                type="button"
                                @click.stop.prevent="toggleMute"
                                class="absolute bottom-3 right-3 z-20 flex h-8 w-8 items-center justify-center rounded-full bg-black/50 text-white transition hover:bg-black/70"
                    ...
                    <div class="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-5 pt-16">
                        <div class="pointer-events-auto flex items-center gap-3">
                            ...
                            <a
                                href="{{ route('users.show', $reel->user) }}"
                ...
                <div class="hidden flex-col items-center gap-5 text-white lg:flex">
                    ...
                    <button
                        ...
                        <span
                            ...
                            {{ $reel->liked_by_users_count > 0 ? $reel->liked_by_users_count : '' }}
                        </span>
                    </button>
                    ...
                    <button
                        type="button"
                        @click.stop.prevent="commentOpen = !commentOpen"
                        class="group flex flex-col items-center gap-1"
                        :aria-label="commentOpen ? 'Close comments' : 'Comment'">
                        ...
                        <span
                            class="text-xs font-semibold text-neutral-400"
                            x-text="commentsCount > 0 ? commentsCount : ''">
                ...
                <div
                    ...
                    x-cloak
                    @click.stop
                    class="absolute right-4 top-1/2 z-10 w-[min(90vw,360px)] -translate-y-1/2 rounded-2xl bg-white p-4 text-neutral-900 shadow-2xl">
                    ...
                    <div class="mb-3 flex items-center justify-between">
                        ...
                        <button
                            ...
                            class="rounded-full px-2 py-1 text-neutral-500 hover:bg-neutral-100"
                    ...
                    <div class="max-h-56 space-y-2 overflow-y-auto text-sm">
                        <template x-for="commentItem in comments" :key="commentItem.id">
                            <p>
                                <span class="font-semibold" x-text="commentItem.user.username"></span>
                                <span x-text="commentItem.body"></span>
                            </p>
                        </template>

                        <p x-show="comments.length === 0" class="text-neutral-500">
                            No comments yet.
                        </p>
                    </div>

                    <form
                        class="mt-3 flex gap-2 border-t border-neutral-200 pt-3"
                        ...
                        <input
                            ...
                            class="min-w-0 flex-1 rounded-lg border-neutral-300 text-sm focus:border-sky-500 focus:ring-sky-500 disabled:opacity-50">

                        <button
                            type="submit"
                            :disabled="!comment.trim() || commentLoading"
                            class="rounded-lg bg-sky-500 px-3 py-2 text-sm font-semibold text-white disabled:opacity-50">
                            Post
                        </button>
                    </form>
                </div>
        ...
        <div class="flex min-h-screen w-full items-center justify-center px-4">
            <div class="flex w-full max-w-sm flex-col items-center rounded-2xl border border-neutral-800 bg-neutral-900 px-6 py-16 text-center">
                ...
                <p class="mt-1.5 text-sm text-neutral-400">
                    When posts are shared, reels will appear here.
                </p>

                <a
                    href="{{ route('reels.create') }}"
                    class="mt-6 rounded-full bg-sky-500 px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-sky-600">
            ...
            document.addEventListener('alpine:init', () => {
                ...
                Alpine.data('reelsPlayer', (reels) => ({
                    ...
                    init() {
                        ...
                        this.$nextTick(() => {
                            this.$el
                                .querySelectorAll('[data-reel-index]')
                                .forEach((el) => {
                ...
                Alpine.data('videoPlayer', (index) => ({
                    ...
                    init() {
                        this.loadTimeout = setTimeout(() => {
                            ...
                            console.error(
                                'Reels video loading timed out:',
                                {
                                    currentSrc:
                                        this.$refs.video?.currentSrc,
                                }
                            );
                        }, 8000);
                    },
